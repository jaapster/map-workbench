import { Ev } from 'se';
import { dis } from 'lite/utils/util-point';
import { dispatch, getState } from 'lite/store/store';
import { dropLast } from 'lite/utils/util-list';
import { NAVIGATION_MODE, THRESHOLD } from 'lite/constants';
import { InteractionMode } from './mode.interaction';
import {
	coToLl,
	llToCo } from 'lite/utils/util-geo';
import {
	newPolygon,
	newLineString } from 'lite/utils/util-geo-json';
import {
	ActionAddVertex,
	ActionAddFeature,
