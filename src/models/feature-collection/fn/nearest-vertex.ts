...
import { dis } from '../../../components/map-control/utils/util-point';
import { coToLl, geoProject } from '../../../components/map-control/utils/util-geo';
...
export const nearestVertex = (lngLat: LngLat, data: FeatureCollection) => (
	data.features.reduce((
		m1: Result,
		{ geometry: { type, coordinates: co1 }, properties }: Feature<any>,
		i: number
	) => {
		if (type === POINT) {
