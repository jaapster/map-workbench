...
import { NAVIGATION_MODE } from '../../../constants/constants';
import { analyseRectangle } from '../../../store/reducers/fn/analyse-rectangle';
...
import {
	...
	ActionUpdateCoordinates } from '../../../store/actions/actions';
import {
	currentCollectionId,
