...
export const getRadius = (feature: FeatureJSON<any>) => {
...
export const getFeatureLength = (feature: FeatureJSON<any>) => {
	const {
		properties: { type },
...
export const getFeatureArea = (feature: FeatureJSON<any>) => {
...
export const getCoordinate = (feature: FeatureJSON<any>) => {
	const {
		properties: { type },
		geometry: { coordinates }
	} = feature;
